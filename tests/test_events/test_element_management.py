...
class TestElementManagement(unittest.TestCase):
    ...
    def test_get_instance_returns_same_instance(self):
        """ 
        Check that get_instance always returns the same instance of 
        ElementManagement
        """
    ...
    def test_element_exists(self):
        """ 
        Check that element_exists returns True if the element exists in the 
        database
        """
    ...
    def test_element_does_not_exist(self):
        """ 
        Check that element_exists returns False if the element does not 
    ...
    def test_create_element_id_exists(self):
        ...
        with self.assertRaises(ElementAlreadyExistsError):
            self.element_management.create_element(
                element_type,
                element_id,
                title,
                schedules,
